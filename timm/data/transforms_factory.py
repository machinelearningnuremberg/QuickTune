    ...
    if tf_preprocessing and use_prefetcher:
        ...
        if is_training and no_aug:
            ...
            if trivial_augment:
                ...
                transform_list.insert(-1, transforms.TrivialAugmentWide())
                transform = transforms.transforms.Compose(transform_list)
            
            if random_augment:
                transform_list = transform.transforms
                transform_list.insert(-1, transforms.RandAugment(num_ops=ra_num_ops, 

...
def get_task_info(version, set, dataset):
    ...
    dataset_size = info_json["median_images_per_category"]*info_json["total_categories"]
...
for super_set in super_sets:
    ...
    metadataset = AFTMetaDataset(aggregate_data=False, set=super_set,
    ...
    for dataset in datasets:
        ...
        cmd = f"--data_path datasets/meta-album " \
